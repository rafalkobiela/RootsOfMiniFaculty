...
d3.tree().nodeSize([dx, dy])
    ...
    },
    {
      ...
      {'children': [{'children': [{'children': [{'children': [{'name': 'Nadzieja  Borowik'}],
      'name': 'Włodzimierz  Waliszewski'}],
    'name': 'Zygmunt  Charzyński'}],
  'name': 'Władysław  Nikliborc'},
 {'children': [{'name': 'Danuta  Sadowska'}], 'name': 'Witold  Pogorzelski'},
 {'children': [{'children': [{'children': [{'children': [{'children': [{'children': [{'children': [{'name': 'Agnieszka  Badeńska'},
               {'name': 'Piotr  Gałązka'}],
              'name': 'Janina  Kotus'}],
   ...
   {'children': [{'name': 'Miron  Zarycki'}], 'name': 'Stanisław  Ruziewicz'},
   {'children': [{'children': [{'name': 'Czesław  Bagiński'}],
      'name': 'Jan  Ambrosiewicz'}],
    'name': 'Antoni  Wakulicz'}],
  'name': 'Wacław  Sierpiński'}],
'name': 'Stanislaw  Zaremba'}
