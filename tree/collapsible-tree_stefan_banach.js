...
d3.tree().nodeSize([dx, dy])
    ...
    },
    {
      name: "data",
      inputs: ["require"],
      value: {'name': 'Stefan  Banach',
      'children': [{'name': 'Stanislaw  Mazur',
        'children': [{'name': 'Maciej  Altman'},
         {'name': 'Andrzej Tadeusz Birkholc'},
         {'name': 'Ryszard  Bittner'},
         {'name': 'Tomasz  Bojdecki'},
         {'name': 'Lej Tsin Gan'},
         {'name': 'Witold  Kolodziej'},
         {'name': 'Tadeusz Jan Lezanski'},
         {'name': 'Wan Dzien Lu'},
         {'name': 'Hanna  Marcinkowska'},
         {'name': 'Krzysztof  Maurin',
          'children': [{'name': 'Janusz  Czyż'},
           {'name': 'Jan  Rogulski'},
           {'name': 'Krzysztof  Gawędzki'},
           {'name': 'Jerzy   Kijowski',
            'children': [{'name': 'Jacek  Jezierski',
              'children': [{'name': 'Witold  Chmielowiec'}]}]},
           {'name': 'Jacek  Komorowski'},
           {'name': 'Wojciech  Lisiecki'},
           {'name': 'Kazimierz  Napiórkowski',
            'children': [{'name': 'Slawomir  Klimek'}]},
           {'name': 'Paweł  Urbański'},
           {'name': 'Stanisław Lech Woronowicz',
            'children': [{'name': 'Paweł Łukasz Kasprzak'},
             {'name': 'Wiesław  Pusz'},
         ...
         {'name': 'Aleksander  Pełczyński',
          'children': [{'name': 'Nicole  Tomczak-Jaegermann'},
           {'name': 'Przemysław  Wojtaszczyk',
            'children': [{'name': 'Paweł  Bechler'}, {'name': 'Tomasz  Wolniewicz'}]}]},
         {'name': 'Stefan  Rolewicz'},
         {'name': 'Maciej  Skwarczyński'},
         {'name': 'Wieslaw  Szlenk'},
         {'name': 'A.  Warzecha'},
         {'name': 'Wieslaw  Zelazko', 'children': [{'name': 'Krzysztof  Jarosz'}]},
         {'name': 'Czeslaw  Bessaga',
          'children': [{'name': 'Henryk  Torunczyk',
            'children': [{'name': 'Tadeusz Wladyslaw Dobrowolski'}]}]}]}]}
    },
    {
      name: "dx",
